        ...
        <div className="relative aspect-video rounded-xl overflow-hidden border border-white/10 mb-6 bg-black shadow-inner">
          {!videoStarted ? (
            ...
            <div className="w-full h-full overflow-hidden relative">
              <iframe
                src="https://www.youtube.com/embed/c5VJNP6-PHE?autoplay=1&controls=0&autohide=1&modestbranding=1&rel=0&showinfo=0&iv_load_policy=3&fs=0&disablekb=1&playsinline=1&loop=1&playlist=c5VJNP6-PHE&cc_load_policy=0&cc_lang_pref=off"
